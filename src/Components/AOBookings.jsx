...
function AOBookings() {
  ...
  return (
    <>
      ...
      >
        <table  >
            <thead className="border-solid border-2 border-white-500"> 
                <tr className="border-solid border-2 border-white-500">
                    <th>Employee</th>
                    <th>From Date</th>
                    <th>To Date</th>
            ...
            <tbody >
                {
                    data.map((user,index)=>{
                        return<tr  key={index} className="border-solid border-2 border-white-500">
                            <td>{user.employee}</td>
